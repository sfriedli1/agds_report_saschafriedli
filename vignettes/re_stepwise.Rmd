...
ggplot(model_results_sorted, aes(x = reorder(predictor, R2), y = R2)) +
  geom_col(fill = "blue") +
  coord_flip() +
  labs(title = "R² für alle bivariaten Modelle",
       x = "Prädiktor", y = expression(R^2)) +
  theme_minimal()
