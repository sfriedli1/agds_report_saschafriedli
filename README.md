...
This repository contains a collection of small Applied Geodata Science projects created as part of an AGDS course report.  
The main deliverables are **five report-style vignettes** (analysis + narrative), supported by reusable helper functions and raw datasets.

## Repository Structure

- **`vignettes/`** – Contains **5 reports** (vignettes).  
